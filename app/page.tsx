...
const Home = () => {
  return (
    <section className='flex items-center flex-col justify-center gap-[10rem]'>
      <section className='flex flex-col items-center justify-center relative lg:gap-0 md:gap-0 sm:gap-3 xsm:gap-3 h-screen'>
        <div className=''>
          <Image
            src='/assets/hero.jpg'
            width={1216}
      ...
      <section className='dark:text-white :text-secondary-900 h-screen flex items-center justify-center flex-col gap-8'>
